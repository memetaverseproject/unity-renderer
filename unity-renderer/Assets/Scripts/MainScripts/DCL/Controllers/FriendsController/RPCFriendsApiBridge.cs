...
using Memetaverse.Renderer.Common;
...
using KernelGetFriendRequestsPayload = Memetaverse.Renderer.KernelServices.GetFriendRequestsPayload;
using KernelRejectFriendRequestReply = Memetaverse.Renderer.KernelServices.RejectFriendRequestReply;
using KernelRejectFriendRequestPayload = Memetaverse.Renderer.KernelServices.RejectFriendRequestPayload;
using KernelCancelFriendRequestReply = Memetaverse.Renderer.KernelServices.CancelFriendRequestReply;
using KernelCancelFriendRequestPayload = Memetaverse.Renderer.KernelServices.CancelFriendRequestPayload;
using RendererRejectFriendRequestReply = Memetaverse.Renderer.RendererServices.RejectFriendRequestReply;
using RendererRejectFriendRequestPayload = Memetaverse.Renderer.RendererServices.RejectFriendRequestPayload;
using RendererCancelFriendRequestReply = Memetaverse.Renderer.RendererServices.CancelFriendRequestReply;
using RendererCancelFriendRequestPayload = Memetaverse.Renderer.RendererServices.CancelFriendRequestPayload;
using RPCFriendshipStatus = Memetaverse.Renderer.KernelServices.FriendshipStatus;
