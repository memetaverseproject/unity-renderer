...
namespace DCL.Wallet
{
    public class WalletSectionHUDControllerShould
    {
        ...
        public void GoToManaPurchaseUrlCorrectly(bool isPolygonNetwork)
        {
            ...
            // Assert
            browserBridge.Received(1).OpenUrl("https://account.memetaverse.club?utm_source=dcl_explorer");
        ...
        public void GoToLearnMoreUrlCorrectly()
        {
            ...
            // Assert
            browserBridge.Received(1).OpenUrl("https://docs.memetaverse.club/examples/get-a-wallet?utm_source=dcl_explorer");
        }
    }
}
