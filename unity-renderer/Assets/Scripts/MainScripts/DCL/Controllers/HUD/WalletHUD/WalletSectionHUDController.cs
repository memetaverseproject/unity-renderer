...
namespace DCL.Wallet
{
    ...
    {
        private const string URL_MANA_INFO = "https://docs.memetaverse.club/examples/get-a-wallet?utm_source=dcl_explorer";
        private const string URL_MANA_PURCHASE = "https://account.memetaverse.club?utm_source=dcl_explorer";
